                  ...
                  ListTile(
                    title: Column(
                      ...
                      children: [
                        ...
                        subTitleText('LICENSE TO USE APP'),
                        secondarySubTitleText('We license you to use:'),
                        content(
                        ...
                        subTitleText('DESCRIPTION OF THE SERVICE'),
                        const SizedBox(
                          height: 10,
                        ),
                        ...
                        subTitleText('ACCEPTABLE USE RESTRICTIONS'),
                        const SizedBox(
                          height: 10,
                        ),
                        secondarySubTitleText('You must not:'),
                        content(
                        ...
                        subTitleText('YOU MUST BE 16 TO ACCEPT THESE TERMS'),
                        content(
                        ...
                        subTitleText('INTELLECTUAL PROPERTY RIGHTS'),
                        content(
                        ...
                        subTitleText('CHANGES TO THESE TERMS'),
                        content(
                  ...
                  ListTile(
                    title: Column(
                      ...
                      children: [
                        ...
                        subTitleText('SCOPE AND CONSENT'),
                        content(
                        ...
                        subTitleText('Information You Provide to Us'),
                        const SizedBox(
                          height: 10,
                        ),
                        secondarySubTitleText(
                        ...
                        subTitleText('Third-Party Information Collection'),
                        const SizedBox(
                          height: 10,
                        ),
                        secondarySubTitleText(
                        ...
                        subTitleText('HOW WE USE YOUR INFORMATION'),
                        const SizedBox(
                          height: 10,
                        ),
                        secondarySubTitleText(
                        ...
                        subTitleText('DISCLOSURE OF YOUR INFORMATION'),
                        content(
                        ...
                        subTitleText('TRANSFERRING YOUR PERSONAL INFORMATION'),
                        content(
                        ...
                        subTitleText('CHILDREN UNDER THE AGE OF 16'),
                        content(
                        ...
                        subTitleText('WITHDRAWING YOUR CONSENT'),
                        content(
                        ...
                        subTitleText('CHANGES TO OUR PRIVACY POLICY'),
                        content(

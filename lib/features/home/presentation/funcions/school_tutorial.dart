...
class TutorialHelper {
  ...
  final GlobalKey offerKey;
  final GlobalKey housingKey;
  ...
  void startTutorial() {
    ...
    List<TargetFocus> targets = [
        ...
        contents: [
          TargetContent(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  "\n\nTap here to view items that are being offered.",
                  style: TextStyle(color: Colors.white),
                ),
                const SizedBox(height: 10),
                ElevatedButton(
      ...
      TargetFocus(
        identify: "HousingChoiceChip",
        keyTarget: housingKey,
        contents: [
          TargetContent(
            align: ContentAlign.bottom,
            child: Column(
              ...
              children: [
                const Text(
                  "\n\nTap here to view housing options.",
                  style: TextStyle(color: Colors.white),
                ),
                const SizedBox(height: 10),
                ElevatedButton(
        ...
        contents: [
          TargetContent(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  "\n\nTap here to view job opportunities.",
                  style: TextStyle(color: Colors.white),
                ),
                const SizedBox(height: 10),
                ElevatedButton(

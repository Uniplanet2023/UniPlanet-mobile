...
import 'package:uniplanet/features/home/presentation/widgets/price_text.dart';
...
class Item extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String schoolName = product.seller.school.toLowerCase();

// Remove 'university' if it exists
    schoolName = schoolName.replaceAll('university', 'Univ').trim();

// Capitalize the first letter
    String capitalizedSchoolName =
        '${schoolName[0].toUpperCase()}${schoolName.substring(1)}';
                      ...
                      children: <Widget>[
                            ...
                            : Row(
                                children: [
                                  Expanded(
                                      child: PriceText(
                                    price: product.price,
                                    optionalPrice: product.originalPrice,
                                  )),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            //   overflow: TextOverflow.ellipsis,
                            // ),
                            prefsHelper.getBool('isMySchool') == true
                                ? const Icon(

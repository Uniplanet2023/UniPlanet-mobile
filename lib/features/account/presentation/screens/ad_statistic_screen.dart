...
class _AdStatisticsScreenState extends State<AdStatisticsScreen> {
  ...
  void _onScroll() {
    if (_controller.position.atEdge &&
            getIt<AdvertiserBloc>().state is! GettingUserInteractionState &&
            getIt<AdvertiserBloc>().state is! EndUserInteractionState &&
            getIt<AdvertiserBloc>().state is GotUserInteractionState ||
        getIt<AdvertiserBloc>().state is GotMoreUserInteractionState) {
      getIt<AdvertiserBloc>().add(const GetMoreUserInteractionEvent());
    }
  }

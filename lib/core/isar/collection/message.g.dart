...
int _messageModelEstimateSize(
  ...
  bytesCount += 3 + object.chat.length * 3;
...
void _messageModelSerialize(
  ...
  writer.writeDateTime(offsets[5], object.readDate);
  writer.writeString(offsets[6], object.receiver);
...
MessageModel _messageModelDeserialize(
  ...
  final object = MessageModel(
    chat: reader.readString(offsets[0]),
    createdAt: reader.readDateTime(offsets[1]),
    id: reader.readString(offsets[2]),
    message: reader.readString(offsets[3]),
    messageType: reader.readString(offsets[4]),
    readDate: reader.readDateTimeOrNull(offsets[5]),
    receiver: reader.readString(offsets[6]),
    sender: reader.readString(offsets[7]),
...
extension MessageModelQueryFilter
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition> chatEqualTo(
    String value, {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition> chatLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition> chatBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition> chatEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition> chatContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition> chatMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition>
      readDateEqualTo(DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'readDate',
        value: value,
...
extension MessageModelQuerySortBy
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> sortByChat() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'chat', Sort.asc);
    });
  }

  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> sortByChatDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> sortByReadDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'readDate', Sort.asc);
    });
  }

  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> sortByReadDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageModelQuerySortThenBy
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> thenByChat() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'chat', Sort.asc);
    });
  }

  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> thenByChatDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'chat', Sort.desc);
    });
  }
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> thenByReadDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'readDate', Sort.asc);
    });
  }

  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> thenByReadDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'readDate', Sort.desc);
    });
  }
...
extension MessageModelQueryWhereDistinct
  ...
  QueryBuilder<MessageModel, MessageModel, QDistinct> distinctByChat(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageModel, QDistinct> distinctByReadDate() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageModelQueryProperty
  ...
  QueryBuilder<MessageModel, String, QQueryOperations> chatProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, DateTime?, QQueryOperations> readDateProperty() {
    return QueryBuilder.apply(this, (query) {
